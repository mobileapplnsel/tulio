...
<a href="solid-curtains" target="_blank"><div class="room-item item1">
...
<h3>CUSHIONS</h3>
 ...
 <!-- Dynamic Slider End -->
    ...
    <section class="hassle-free-experience">
        <div class="image-container">
            <picture>
                    <source media="(min-width: 1024px)" srcset="{{asset('assets/bannerbg.png')}}">
                    <source media="(max-width: 1023px)" srcset="{{asset('assets/mobile-hasslebg.jpg')}}">
                    <img loading="lazy"  onerror="imgError(this);"  src="{{asset('assets/bannerbg.png')}}" alt="" />
