...
Crafting happiness <br> since 1990
    ...
    <section class="fulfillment-center">
      ...
      <center>
          ...
          <p>Our centers help you see a project from conceptualization to installation. With dedicated relationship managers, designers, <br>
project managers and technicians, our centers help us deliver what we promise
            </p>
            <p>&nbsp;</p>
      ...
      <!--
        <ul class="center-images">
          <li>
            <div class="desktop-image image-container">
              <img data-src="{{asset('assets/center1.svg')}}" alt="" class="lazy" />
            </div>
            <div class="mobile-image image-container">
              <img data-src="{{asset('assets/mobile-center1.svg')}}" alt="" class="lazy" />
            </div>
          </li>
          <li>
            <div class="desktop-image image-container">
              <img data-src="{{asset('assets/center2.svg')}}" alt="" class="lazy" />
            </div>
            <div class="mobile-image image-container">
              <img data-src="{{asset('assets/mobile-center2.svg')}}" alt="" class="lazy" />
            </div>
          </li>
          <li>
            <div class="desktop-image image-container">
              <img data-src="{{asset('assets/center3.svg')}}" alt="" class="lazy" />
            </div>
            <div class="mobile-image image-container">
              <img data-src="{{asset('assets/mobile-center3.svg')}}" alt="" class="lazy" />
            </div>
          </li>
          <li>
            <div class="desktop-image image-container">
              <img data-src="{{asset('assets/center4.svg')}}" alt="" class="lazy" />
            </div>
            <div class="mobile-image image-container">
              <img data-src="{{asset('assets/mobile-center4.svg')}}" alt="" class="lazy" />
            </div>
          </li>
        </ul> -->
        ...
        <ul class="center-address">
          <li>
            ...
            Gurugram - 122015
            <p class="viewOnMap"><a href="https://goo.gl/maps/Wvqy5h4DxWzh4LY16" target="_blank">View on map</a></p>
            </div>
            <!-- <div class="contact-details">
              <div class="contact-1">
                <span>Email: info@tulips.design</span>
                <span>Tel: 9225555564</span>
              </div>
              <div class="contact-2">
                <span>10:00 AM - 07:00</span> <span>PM Monday - Saturday</span>
              </div>
            </div> -->
          </li>
          <li>
...
Pune - 411016
              <p class="viewOnMap"><a href="https://goo.gl/maps/EeJCLqBATscv2NzX7" target="_blank">View on map</a></p>
            </div>
...
Papanna Street<br>
Bengaluru - 560 001
              <p class="viewOnMap"><a href="https://goo.gl/maps/d8dEdrjcbJ5A87UR9" target="_blank">View on map</a></p>
            </div>
...
Worli, Mumbai - 400013
              <p class="viewOnMap"><a href="https://goo.gl/maps/D7smq77yQ8XbmGte9" target="_blank">View on map</a></p>
            </div>
...
Dubai, UAE.
              ...
              <p class="viewOnMap"><a href="https://goo.gl/maps/YmYQh2MLwCsFu9Y76" target="_blank">View on map</a></p>
            </div>
