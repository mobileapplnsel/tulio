        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::text('last_name',null, ["placeholder"=>"Enter name ","class"=>"form-control", "id"=>"last_name"]) !!}
                    @error('last_name')
                    <strong>{{ $message }}</strong>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::select('user_type',['2'=>'Designer','3'=>'Architect','4'=>'Tulio'],null, ["placeholder"=>"Select Type ","class"=>"form-control", "id"=>"usertype"]) !!}
                        @error('user_type')
                        <strong>{{ $message }}</strong>
                        @enderror
                  </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                <div class="form-group">
                    <label for="poc_name">Contact Name</label>
                ...
                <div class="col-sm-6">
                <div class="form-group">
                    <label for="poc_number">Contact Phone</label>
