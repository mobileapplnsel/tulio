...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5CZ3J2C"
    ...
    <script>window.onload = function getIPDetails() {
...
{{--Promote A+id register--}}
              ...
              <div class="modal fade" id="promoteModal" tabindex="-1" aria-labelledby="promoteModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="promoteModalLabel">Browse an exclusive collection of 500+ designs by signing-up / signing-in for access </h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
